...
The Cabin Area Control Panel detects the published file automatically and uses native offline playback. If it is absent, development builds retain the online YouTube preview fallback.
